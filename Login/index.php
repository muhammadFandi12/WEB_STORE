...
if (isset($_POST["login"])){
    ...
    $resultRole = mysqli_query($conn, "SELECT roles FROM data_user WHERE username = '$username'");
    ...
    if(mysqli_num_rows($result) === 1) {
        ...
        if (password_verify($password, $row['password'])){
            ...
            // user:user1, pw:user1
                ...
                header("Location: ../dashboard/user/shop.php");
                // echo "User";
                // exit;
            }    
        }
...
<main>
  <div class="form-container">
    ...
    <form class="form" action="index.php" method="post">
      ...
      <?php if (isset ($error)):?>
        <p style = "font-style: italic; color: rgb(255, 34, 34); text-align: center;  margin-bottom: 5px;">
    ...
    <p class="signup">Don't have an account?
      <a rel="noopener noreferrer" href="regis.php" class="">Sign up</a>
    </p>
  </div>
</main>
